<template>
  <div class="card">
    <div class="card-header">
      <i class="fa fa-table" aria-hidden="true"></i> Rata rata Lama Sekolah
...
export default {
  ...
  methods: {
    createRow() {
      window.location = '#/admin/rr-lama-sekolah/create';
    },
    viewRow(rowData) {
      window.location = '#/admin/rr-lama-sekolah/' + rowData.id;
    },
    editRow(rowData) {
      window.location = '#/admin/rr-lama-sekolah/' + rowData.id + '/edit';
    },
    deleteRow(rowData) {
      let app = this;

      if (confirm('Do you really want to delete it?')) {
        axios.delete('/api/rr-lama-sekolah/' + rowData.id)
